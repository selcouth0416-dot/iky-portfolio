              ...
              <Reveal>
                <div className="two-column">
                  <div>
                    <h3>Who Am I</h3>
                    <p>
                      Saya Iky, berfokus pada menciptakan tampilan dan
                      pengalaman pengguna yang sederhana, cepat, dan
                      fungsional.
                    </p>
                  </div>
                  ...
                  <div>
                    <h3>My Approach</h3>
                    <p>
                      Saya mengutamakan clean code, desain responsif, dan
                      pengalaman pengguna yang intuitif dalam setiap proyek.
                    </p>
                  </div>
                </div>
              </Reveal>
              ...
              <Reveal delay={0.08}>
                <div className="detail-block">
                  ...
                  <div className="details">
                    <div>
                      <span>Nama</span>
                      <strong>Muhammad Risky</strong>
                    </div>

                    <div>
                      <span>Lahir</span>
                      <strong>4 November 2002</strong>
                    </div>
                    ...
                    <div>
                      <span>Email</span>
                      <strong>muhammadrzky101@gmail.com</strong>
                    </div>
                  </div>
                </div>
              </Reveal>
          ...
          <div className="hobby-grid">
            {[
              ...
              [
                BookOpen,
                "Reading",
                "Membaca untuk belajar ide dan perspektif baru.",
              ],
              [
                ChefHat,
                "Cooking",
                "Bereksperimen dengan makanan dan resep baru.",
              ],
            ...
            {["Frontend", "Backend Core"].map((group) => (
              <Reveal key={group} className="stack-row">
                <div className="stack-copy">
                  ...
                  <p>
                    {group === "Frontend"
                      ? "The tools I use to build beautiful, responsive, and interactive user interfaces."
                      : "The foundations of the APIs and services I build for web apps and bots."}
                  </p>
                </div>
          ...
          <div className="contact-grid">
            <Reveal className="contact-card">
              ...
              <div className="contact-meta">
                <div>
                  <Mail size={16} /> muhammadrzky101@gmail.com
                </div>

                <div>
                  <Phone size={16} /> +62 831-4020-9281
                </div>

                <div>
                  <MapPin size={16} /> Samarinda, Kalimantan Timur
                </div>
              </div>
